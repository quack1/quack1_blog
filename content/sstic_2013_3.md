...
J'ai trouvé cette conférence assez intéressante. [Galadrim](https://twitter.com/g4l4drim) montre comment il utilise des payloads XSS dans des pages Web pour déterminer le navigateur utilisé. Pour cela, il a une liste complète 

#TODO:
Les slides de mon talk #SSTIC http://xss.labosecu.rennes.telecom-bretagne.eu/static/prez/fingerprinting.html l'outil: http://xss.labosecu.rennes.telecom-bretagne.eu/ et les sources: https://github.com/g4l4drim/xss_test_driver
